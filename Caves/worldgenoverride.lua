return {
	...
	overrides = {
		...
		cavelight = "fast", 			-- "veryslow", "slow", "default", "fast", "veryfast"
		...
		meteorspawner = "never", 		-- "never", "rare", "default", "often", "always"
		meteorshowers = "never", 		-- "never", "rare", "default", "often", "always"
		...
		ponds = "rare", 				-- "never", "rare", "default", "often", "always"
		...
		houndmound = "rare", 		-- "never", "rare", "default", "often", "always"
		merm = "default", 				-- "never", "rare", "default", "often", "always"
		tentacles = "rare", 			-- "never", "rare", "default", "often", "always"
		...
		antliontribute = "never", 	-- "never", "rare", "default", "often", "always"
		bats = "rare", 				-- "never", "rare", "default", "often", "always"
		fissure = "default", 			-- "never", "rare", "default", "often", "always"
		wormattacks = "rare", 		-- "never", "rare", "default", "often", "always"
